...
public class TencentActivity extends AppCompatActivity implements DialogInterface.OnClickListener, TencentLocationListener {

    private static final String[] NAMES = new String[] { "GEO", "NAME", "ADMIN AREA", "POI"};
    private static final int[] LEVELS = new int[] {TencentLocationRequest.REQUEST_LEVEL_GEO, TencentLocationRequest.REQUEST_LEVEL_NAME, TencentLocationRequest.REQUEST_LEVEL_ADMIN_AREA, TencentLocationRequest.REQUEST_LEVEL_POI};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationStatus = (TextView) findViewById(R.id.editmapText);
    ...
    public void startLocation(View view) {
        // 创建定位请求
        TencentLocationRequest request = TencentLocationRequest.create().setInterval(5000); // 设置定位周期.setRequestLevel(mLevel); // 设置定位level
